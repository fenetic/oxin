...
export declare type UseFormup = [FormState, FormupPropsFunction];
...
export declare type FormupPropsFunction = (options: FieldOptions) => FormupProps;
export interface ValidationProps {
    valid: boolean;
    messages: any[];
}
export interface FormupProps {
    name: string;
    type?: string;
    value?: any;
    label: string | ReactNode;
